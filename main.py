...
def main(task, num_epoch, batch_size, teacher_forcing, first_n_frame_dynamics, frame_interval):
    ...
    for i in range(num_epoch):
        ...
        for j, batch in tqdm(enumerate(train_dataloader)):
            ...
            pred_labels, pred_images_seq = model(task, coordinates, frames, device)
            ...
            for k, pred_images in enumerate(pred_images_seq[:-1]):
                ...
                image_mse_loss = mse_loss(pred_images, frames[k])
...
if __name__ == '__main__':
    ...
    main('contact', num_epoch, batch_size, teacher_forcing, first_n_frame_dynamics, frame_interval)